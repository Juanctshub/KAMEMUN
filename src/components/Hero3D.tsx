...
export default function Hero3D() {
  ...
  return (
    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-full md:w-[55%] h-full z-0 flex items-center justify-center pointer-events-none md:pointer-events-auto">
      <motion.div
