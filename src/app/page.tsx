            ...
            <div id="inicio" className="relative w-full min-h-screen pt-20 md:pt-48">
              ...
              <section className="w-full h-full flex flex-col items-start justify-center px-6 md:px-24 lg:px-32 z-10 relative pointer-events-none">
                <div className="max-w-4xl pointer-events-auto">
                  ...
                  >
                    <p className="text-brand-primary-light font-black tracking-[0.4em] uppercase mb-4 text-[10px] sm:text-xs md:text-sm flex items-center gap-4 drop-shadow-lg">
                    ...
                    <div className="relative">
                      ...
                      <h1 className="relative z-10 text-[2.75rem] sm:text-6xl md:text-[5rem] lg:text-[6.5rem] font-serif font-black tracking-tight leading-[0.95] text-brand-accent drop-shadow-2xl">
                        El Camino <br />
                  ...
                  <motion.p 
                    ...
                    className="mt-6 md:mt-10 text-brand-silver text-sm sm:text-base md:text-xl font-light max-w-xl leading-relaxed drop-shadow-md"
                  >
                    Delegación Universitaria Independiente del Estado Lara. <br className="hidden md:block" /> Avanzamos con resiliencia y paciencia, transformando cada debate en oportunidades reales.
                  </motion.p>
